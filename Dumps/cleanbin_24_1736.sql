...
--
-- Host: localhost
-- Generation Time: Nov 24, 2016 at 05:36 
...
--
-- Table structure for table `nodiPercorsi`
--

CREATE TABLE `nodiPercorsi` (
  `Id` int(11) NOT NULL,
...
--
-- Indexes for table `nodiPercorsi`
--
ALTER TABLE `nodiPercorsi`
...
--
ALTER TABLE `turni`
  ADD PRIMARY KEY (`Utente_id`,`Percorso_id`),
  ADD KEY `fk_Camion_perTurni` (`Camion_id`),
  ADD KEY `fk_Percorso_perTurni` (`Percorso_id`),
  ADD KEY `fk_Percorsi_perTurni` (`Percorso_id`);
...
--
-- Constraints for table `nodiPercorsi`
--
ALTER TABLE `nodiPercorsi`
  ...
  ADD CONSTRAINT `fk_Percorso_perNodiPercorsi` FOREIGN KEY (`Id`) REFERENCES `percorso` (`Id`);
...
ALTER TABLE `turni`
  ...
  ADD CONSTRAINT `fk_Percorsi_perTurni` FOREIGN KEY (`Percorso_id`) REFERENCES `percorso` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
