...
--
-- Host: localhost
-- Generation Time: Nov 24, 2016 at 03:01 
...
ALTER TABLE `camion`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `fk_Tipologie_perCamion` (`Tipologia_id`);
...
--
ALTER TABLE `turni`
  ADD PRIMARY KEY (`Utente_id`,`Percorso_id`,`Cluster_id`),
...
--
ALTER TABLE `camion`
  ADD CONSTRAINT `fk_Tipologie_perCamion` FOREIGN KEY (`Tipologia_id`) REFERENCES `tipologie` (`Id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `turni`
  ADD CONSTRAINT `fk_Camion_perTurni` FOREIGN KEY (`Camion_id`) REFERENCES `camion` (`Id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Percorso_perTurni` FOREIGN KEY (`Percorso_id`,`Cluster_id`) REFERENCES `percorsi` (`Id`, `Cluster_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
